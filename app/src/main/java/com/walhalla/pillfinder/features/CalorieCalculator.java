...
import com.walhalla.health.CalorieCalculator.CalorieCalculatorFragment;
...
public class CalorieCalculator extends InnerAdActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .add(R.id.scrollcontainer, new CalorieCalculatorFragment())
                    .commit();
        }
    }
}
